...
namespace frontend {
    ...
    HIRToMIRVisitor::HIRToMIRVisitor(middleend::mir::Type function_type,
                                     middleend::mir::LiteralMap &literal_map)
        : new_basic_block(true), function_type(function_type),
          literal_map(literal_map) {
        // TODO: handle void
        auto ret_val =
            std::make_unique<middleend::mir::InstructionAlloca>(function_type);
        ret_alloca = ret_val.get();
        cur_instructions.push_back(std::move(ret_val));
    }

    std::list<std::unique_ptr<middleend::mir::BasicBlock>>
    HIRToMIRVisitor::getResult() {
    ...
    middleend::mir::Value *
    HIRToMIRVisitor::getLiteral(uint64_t value, middleend::mir::Type type) {
    ...
    void HIRToMIRVisitor::createBasicBlock(
        ...
        auto new_block = std::make_unique<middleend::mir::BasicBlock>(
    ...
    void HIRToMIRVisitor::connectBasicBlocks() {
        ...
        if (!new_basic_block) {
            auto branch =
                std::make_unique<middleend::mir::TerminatorBranch>(nullptr);
        ...
        // TODO: handle void
        auto ret_load = std::make_unique<middleend::mir::InstructionLoad>(
            function_type, ret_alloca);
        auto ret_terminator =
            std::make_unique<middleend::mir::TerminatorReturn>(ret_load.get());
        std::list<std::unique_ptr<middleend::mir::Instruction>> ret_body;
        ret_body.push_back(std::move(ret_load));
        auto ret_block = std::make_unique<middleend::mir::BasicBlock>(
        ...
        std::unordered_map<uint64_t, middleend::mir::BasicBlock *> label_to_bb;
        size_t i = 0;
        ...
        for (auto &bb : basic_blocks) {
            ...
            auto branch =
                dynamic_cast<middleend::mir::TerminatorBranch *>(terminator);
            if (branch) {
            ...
            auto cond_branch =
                dynamic_cast<middleend::mir::TerminatorCondBranch *>(
                    terminator);
            if (cond_branch) {
    ...
    void HIRToMIRVisitor::visit(hir::InstructionAssignValue *i) {
        ...
        auto store =
            std::make_unique<middleend::mir::InstructionStore>(value, ptr);
    ...
    void HIRToMIRVisitor::visit(hir::InstructionAssignUnaryOp *i) {
        ...
        middleend::mir::InstructionAlloca *ptr =
            value_mappings.at(i->getVariable()->getValue());
        auto store =
            std::make_unique<middleend::mir::InstructionStore>(un_op_res, ptr);
        cur_instructions.push_back(std::move(store));
    }
    ...
    void HIRToMIRVisitor::visit(hir::InstructionAssignBinaryOp *i) {
        ...
        auto bin_op = std::make_unique<middleend::mir::InstructionBinaryOp>(
            type, op, left, right);
    ...
    void HIRToMIRVisitor::visit(hir::InstructionReturn *i) {
        ...
        middleend::mir::InstructionAlloca *ptr = ret_alloca;
        auto store =
            std::make_unique<middleend::mir::InstructionStore>(retVal, ptr);
        cur_instructions.push_back(std::move(store));
    ...
    void HIRToMIRVisitor::visit(hir::InstructionCall *i) {
        ...
        for (auto &arg : i->getArguments()) {
            middleend::mir::Value *arg_val = resolveAtom(arg.get());
    ...
    void HIRToMIRVisitor::visit(hir::InstructionCallAssign *i) {
        ...
        middleend::mir::InstructionAlloca *ptr =
            value_mappings.at(i->getVariable()->getValue());
        auto store =
            std::make_unique<middleend::mir::InstructionStore>(call.get(), ptr);
    ...
    void HIRToMIRVisitor::visit(hir::InstructionBranchCond *i) {
        ...
        auto branch = std::make_unique<middleend::mir::TerminatorCondBranch>(
