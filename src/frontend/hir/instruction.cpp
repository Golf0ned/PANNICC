...
namespace frontend::hir {
    ...
    InstructionCall::InstructionCall(AtomIdentifier *callee) : callee(callee) {}

    AtomIdentifier *InstructionCall::getCallee() { return callee; }
    ...
    AtomIdentifier *InstructionCallAssign::getCallee() { return callee; }
