...
const std::vector<RegisterNum> &getAllRegisters() {
    static std::vector<RegisterNum> all_registers = {
        RegisterNum::RAX, RegisterNum::RCX, RegisterNum::RDX, RegisterNum::RBX,
        RegisterNum::RSI, RegisterNum::RDI, RegisterNum::RSP, RegisterNum::RBP,
        RegisterNum::R8,  RegisterNum::R9,  RegisterNum::R10, RegisterNum::R11,
        RegisterNum::R12, RegisterNum::R13, RegisterNum::R14, RegisterNum::R15,
    };
...
const std::vector<RegisterNum> &getCalleeSavedRegisters() {
    static std::vector<RegisterNum> callee_saved = {
        RegisterNum::RBX, RegisterNum::RSP, RegisterNum::RBP, RegisterNum::R12,
        RegisterNum::R13, RegisterNum::R14, RegisterNum::R15,
    };
    return callee_saved;
}
...
const std::vector<RegisterNum> &getColoringPriority() {
    static std::vector<RegisterNum> coloring_priority = {
        RegisterNum::R10, RegisterNum::R11, RegisterNum::RDI, RegisterNum::RSI,
        RegisterNum::RDX, RegisterNum::RCX, RegisterNum::R8,  RegisterNum::R9,
        RegisterNum::RAX, RegisterNum::RBX, RegisterNum::R12, RegisterNum::R13,
