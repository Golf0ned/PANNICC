...
void Function::setStackBytes(uint64_t new_bytes) { stack_bytes = new_bytes; }
...
std::string Function::toString() {
    ...
    std::string annotation = "  # " + std::to_string(num_params) + " params, " +
                             std::to_string(stack_bytes) + " stack bytes";
