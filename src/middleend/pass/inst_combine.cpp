#include "middleend/pass/inst_combine.h"
        ...
        for (auto &f : p.getFunctions()) {
            ...
            while (changed) {
                ...
                for (auto &bb : f.getBasicBlocks()) {
                    ...
                    for (size_t ind = 0; ind < instructions.size(); ind++) {
                        ...
                        case mir::BinaryOp::ADD:
                            folded_val = left->getValue() + right->getValue();
                            break;
                        ...
                        ReplaceUsesVisitor visitor(bin_op, folded_literal.get(),
                                                   bb.get());
                ...
                for (auto &bb : f.getBasicBlocks()) {
                    ...
                    new_body.reserve(instructions.size() - block_erase.size());
